...
<head>
  ...
  <style>
    ...
    html {
      ...
      background-color: #f8f9fa; /* Change background color to a light shade */
    }
    .navbar {
...
<div class="jumbotron">
  <div class="content text-center" style="color: black">
    ...
    <p>
      Welcome to MediSlot, where we're on a mission to transform the way you
      access healthcare. Founded with a vision of making quality healthcare
      more accessible and convenient for everyone, MediSlot is your go-to
      destination for seamless appointment booking and healthcare
      management. At MediSlot, we understand the frustration and challenges
      that often accompany the traditional healthcare system. Long wait
      times, confusing appointment processes, and limited access to
      healthcare providers can make managing your health a daunting task.
      That's why we've made it our goal to simplify and streamline the
      entire healthcare experience. Our platform is designed with you in
      mind, putting the power of healthcare management directly into your
      hands. Whether you're scheduling a routine check-up, seeking
      specialized care, or simply in need of urgent medical attention,
      MediSlot is here to help. With a comprehensive network of trusted
      healthcare providers and a user-friendly interface, finding and
      booking appointments has never been easier. But MediSlot is more than
      just a booking platform. We're committed to fostering a community of
      health-conscious individuals who prioritize their well-being.
    </p>
  </div>
