...
@WebServlet("/bookedAppointment")
public class BookedAppointment extends HttpServlet {
	...
	protected void service(HttpServletRequest req, HttpServletResponse res) throws IOException {
		try {
			...
			Appointment appointment = new Appointment(patient, doctorSchedule, gender, pAge, bloodGroup, address,
					preferredDate, preferredTime, appointmentReason);
