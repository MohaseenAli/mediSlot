...
<body>
	<%
	try {
		System.out.print(request.getParameter("planID"));
		int planID = Integer.parseInt((String) request.getParameter("planID"));
		...
		TreatmentPlan treatmentPlan = treatmentPlanService.findById(planID);
	%>
			...
			<div class="navbar-collapse">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item"><a class="nav-link"
						href="manage_prescription.jsp">Go Back Prescription</a></li>
					<li class="nav-item"><a class="nav-link"
