...
<body>
	...
	try {
		...
		List<TreatmentPlan> treatmentPlans = treatmentPlanService.findAllRecordByPatientId(patientID);
	%>
	...
	<div class="container">
		...
		%>
		<h1 align="center">Medical Records</h1>
		<table>
			<thead>
				<tr>
					<th>Doctor Name</th>
			...
			<tbody>
				...
				%>
				<tr>
					<td><%=treatmentPlan.getAppointment().getDoctorSchedule().getDoctor().getDoctorName() %></td>
